export const agencyList = {
    agency: [
        ...
        { title: 'APL', regionTitle: 'Maryland', tag: 'jhu-apl' },
        {
        ...
        { title: 'Config Stuff', regionTitle: 'Other', tag: 'configdev' },
        { title: 'CyRide', regionTitle: 'Iowa', tag: 'cyride' },
        {
            title: 'DC Circulator',
        ...
        { title: 'MBTA', regionTitle: 'Massachusetts', tag: 'mbta' },
        {
        ...
        { title: 'RTC RIDE, Reno', regionTitle: 'Nevada', tag: 'reno' },
        {
        ...
        { title: 'Trinity Metro', regionTitle: 'Texas', tag: 'ft-worth' },
        {
            title: 'UCLA',
            regionTitle: 'California-Southern',
            tag: 'bruinbus'
